...
pool_history/_attn_pool copy nguyên từ model/retriever/src/model.py:185-210 (không dựng được TwoTower vì
...
ARTIFACTS = ROOT.parent.parent / "artifacts"           # repo root
RETRIEVER_SRC = ROOT.parent / "retriever" / "src"      # model/retriever/src
